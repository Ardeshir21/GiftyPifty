...
class Product(models.Model):
    ...
    ocassion = models.ManyToManyField(Ocassion, related_name='ocassions', null=True, blank=True)
    interest = models.ManyToManyField(Interest, related_name='interests', null=True, blank=True)
    tag = models.ManyToManyField(Tag, related_name='tags', null=True, blank=True)
    recipient = models.ManyToManyField(Recipient, related_name='recipients', null=True, blank=True)
